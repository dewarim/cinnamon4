...
public enum UrlMapping {
    ...
    ACL_ENTRY__LIST_ACL_ENTRIES_BY_GROUP_OR_ACL("aclEntry", "listAclEntries", "/api"),
    ACL_ENTRY__LIST("aclEntry", "list", "/api"),
    ACL_ENTRY__CREATE("aclEntry", "create", "/api"),
    ACL_ENTRY__UPDATE("aclEntry", "update", "/api"),
    ACL_ENTRY__DELETE("aclEntry", "delete", "/api"),
