...
public enum UrlMapping {
    ...
    NULL_MAPPING("", "", "/api"),
    OBJECT_TYPE__LIST("objectType", "list", "/api"),
    OBJECT_TYPE__CREATE("objectType", "create", "/api"),
    OBJECT_TYPE__UPDATE("objectType", "udpate", "/api"),
    OBJECT_TYPE__DELETE("objectType", "delete", "/api"),
