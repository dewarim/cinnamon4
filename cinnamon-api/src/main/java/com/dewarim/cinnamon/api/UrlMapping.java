...
public enum UrlMapping {
    ...
    ACL_ENTRY__LIST_ACL_ENTRIES_BY_GROUP_OR_ACL("aclGroup", "listAclGroups", "/api"),
    ACL_ENTRY__LIST("aclGroup", "list", "/api"),
    ACL_ENTRY__CREATE("aclGroup", "create", "/api"),
    ACL_ENTRY__UPDATE("aclGroup", "update", "/api"),
    ACL_ENTRY__DELETE("aclGroup", "delete", "/api"),
