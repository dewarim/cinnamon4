...
public enum ErrorCode {
    ...
    NO_LIFECYCLE_STATE_WRITE_PERMISSION("missing permission to set lifecycle state", HttpServletResponse.SC_UNAUTHORIZED),
    ...
    NO_NAME_WRITE_PERMISSION("missing permission to rename object", HttpServletResponse.SC_UNAUTHORIZED),
    NO_TYPE_WRITE_PERMISSION("missing permission change object's type", HttpServletResponse.SC_UNAUTHORIZED),
