...
public enum UrlMapping {
    ...
    FOLDER__GET_FOLDER_BY_RELATIVE_PATH("folder", "getFolderByRelativePath", "/api", "Fetch a folder specified by its relative path. The relative path must not start or end with a forward slash: '/'.", FolderPathRequest.class, FolderWrapper.class),
