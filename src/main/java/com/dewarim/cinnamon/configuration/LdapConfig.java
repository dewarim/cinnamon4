...
public class LdapConfig {
    ...
    private boolean ldapConnectorEnabled = false;
    ...
    public boolean isLdapConnectorEnabled() {
        return ldapConnectorEnabled;
    }

    public void setLdapConnectorEnabled(boolean ldapConnectorEnabled) {
        this.ldapConnectorEnabled = ldapConnectorEnabled;
    }
