...
echo " <BooleanQuery><Clause occurs='must'><PointRangeQuery fieldName='root' lowerTerm='500' upperTerm='9223372036854775807' type='long' lowerInclusive='true' upperInclusive='true'/></Clause></BooleanQuery>" > /tmp/booleanQuery.xml
