...
alter table lifecycles
    add constraint fk_default_state_id FOREIGN KEY
...
(
    ...
    name      varchar(255) UNIQUE,
    parent_id bigint
        constraint fk_group_parent_id references groups
);
...
(
    id                  bigint       not null
        constraint index_job_pkey primary key,
...
-- #3
INSERT INTO users(id, name, pwd, activated, ui_language_id, fullname, activate_triggers)
VALUES (nextval('seq_user_id'), 'deactivated user', '$2a$10$VG9LCf6h/Qwb7Y.pafHkaepdnJNgFZUzzuMV3EcyvLbKnueHQ4IW.',
        false, 1, 'inactive', true);
-- #4
INSERT INTO users(id, name, pwd, activated, locked, ui_language_id, fullname, activate_triggers)
VALUES (nextval('seq_user_id'), 'locked user', '$2a$10$VG9LCf6h/Qwb7Y.pafHkaepdnJNgFZUzzuMV3EcyvLbKnueHQ4IW.', true,
        true, 1, 'locked', true);
-- #5 - LDAP user
INSERT INTO users(id, name, pwd, activated, locked, ui_language_id, fullname, activate_triggers, login_type)
VALUES (nextval('seq_user_id'), 'ldap', '$2a$10$VG9LCf6h/Qwb7Y.pafHkaepdnJNgFZUzzuMV3EcyvLbKnueHQ4IW.', true, true, 1,
        'ldap-user', true, 'LDAP');


insert into acls(id, name)
values (nextval('seq_acl_id'), '_default_acl'); -- 1
insert into acls(id, name)
values (nextval('seq_acl_id'), 'reviewers.acl');
-- 2

-- #1
insert into object_types(id, name)
values (nextval('seq_obj_type_id'), '_default_objtype');

insert into groups(id, name)
VALUES (nextval('seq_group_id'), '_superusers'); -- #1
insert into groups(id, name)
VALUES (nextval('seq_group_id'), '_1_admin'); -- #2
insert into groups(id, name, parent_id)
VALUES (nextval('seq_group_id'), 'admin_child_group', 2); -- #3
insert into groups(id, name)
VALUES (nextval('seq_group_id'), '_2_doe'); -- #4
insert into groups(id, name)
values (nextval('seq_group_id'), 'reviewers'); -- #5
insert into groups(id, name)
values (nextval('seq_group_id'), '_everyone'); -- #6
insert into groups(id, name)
values (nextval('seq_group_id'), '_owner');
-- #7

-- #1 admin is member of superuser group:
insert into group_users(id, user_id, group_id)
VALUES (nextval('seq_group_user_id'), 1, 1);
-- #2 admin is member of admin group:
insert into group_users(id, user_id, group_id)
VALUES (nextval('seq_group_user_id'), 1, 2);
-- #3 doe is member of his own group:
insert into group_users(id, user_id, group_id)
VALUES (nextval('seq_group_user_id'), 2, 4);
-- #4 doe is member of reviewers:
insert into group_users(id, user_id, group_id)
values (nextval('seq_group_user_id'), 2, 5);

-- #1 link superusers group to default acl:
insert into acl_groups(id, acl_id, group_id)
values (nextval('seq_acl_group_id'), 1, 1);
-- #2 admin's group is connected to reviewers acl:
insert into acl_groups(id, acl_id, group_id)
values (nextval('seq_acl_group_id'), 2, 2);
-- #3 doe's group is connected to reviewers.acl
insert into acl_groups(id, acl_id, group_id)
values (nextval('seq_acl_group_id'), 2, 4);
-- #4 reviewers are connected to reviewers acl:
insert into acl_groups(id, acl_id, group_id)
values (nextval('seq_acl_group_id'), 2, 5);

insert into permissions
values (nextval('seq_permission_id'), 'node.browse');
insert into permissions
values (nextval('seq_permission_id'), 'folder.create.folder');
insert into permissions
values (nextval('seq_permission_id'), 'folder.create.object');
insert into permissions
values (nextval('seq_permission_id'), 'node.delete');
insert into permissions
values (nextval('seq_permission_id'), 'node.name.write');
insert into permissions
values (nextval('seq_permission_id'), 'node.type.write');
insert into permissions
values (nextval('seq_permission_id'), 'object.lock');
insert into permissions
values (nextval('seq_permission_id'), 'object.language.write');
insert into permissions
values (nextval('seq_permission_id'), 'link.target.write');
insert into permissions
values (nextval('seq_permission_id'), 'node.parent_folder.write');
insert into permissions
values (nextval('seq_permission_id'), 'object.content.read');
insert into permissions
values (nextval('seq_permission_id'), 'node.metadata.read');
insert into permissions
values (nextval('seq_permission_id'), 'node.acl.write');
insert into permissions
values (nextval('seq_permission_id'), 'node.summary.write');
insert into permissions
values (nextval('seq_permission_id'), 'node.owner.write');
insert into permissions
values (nextval('seq_permission_id'), 'object.version');
insert into permissions
values (nextval('seq_permission_id'), 'object.content.write');
insert into permissions
values (nextval('seq_permission_id'), 'node.metadata.write');
insert into permissions
values (nextval('seq_permission_id'), 'relation.child.add');
insert into permissions
values (nextval('seq_permission_id'), 'relation.parent.add');
insert into permissions
values (nextval('seq_permission_id'), 'relation.child.remove');
insert into permissions
values (nextval('seq_permission_id'), 'relation.parent.remove');
insert into permissions
values (nextval('seq_permission_id'), 'object.lifecyclestate.write');

-- #1 default folder type
insert into folder_types(id, name)
values (nextval('seq_folder_type_id'), '_default_folder_type');
...
values (nextval('seq_language_id'), 'de_DE');
-- #2 language: en
insert into languages (id, iso_code)
values (nextval('seq_language_id'), 'en_EN');
-- #3 language: multiple
insert into languages (id, iso_code)
values (nextval('seq_language_id'), 'mul');
-- #4 language: undetermined
insert into languages (id, iso_code)
values (nextval('seq_language_id'), 'und');
-- #5 language: no-language
insert into languages (id, iso_code)
values (nextval('seq_language_id'), 'zxx');
...
-- #1 uiLanguage: de
insert into ui_languages (id, iso_code)
values (nextval('seq_ui_language_id'), 'DE');

-- #2 uiLanguage: en
insert into ui_languages (id, iso_code)
values (nextval('seq_ui_language_id'), 'EN');
...
values (nextval('seq_index_item_id'), 'xml_content', false, 'xml content',
        '/objectSystemData/content/descendant::*', 'boolean(string-length(/objectSystemData/formatId[text()])>0)', true,
        'DESCENDING_STRING_INDEXER');
insert into index_items(id, fieldname, multiple_results,
                        name, search_string, search_condition, store_field, index_type)
...
insert into lifecycles(id, name, default_state_id)
VALUES (nextval('seq_lifecycle_id'), 'review.lc', null);
-- #2 lifecycle render.lc (without any states, to test missing default state )
insert into lifecycles(id, name, default_state_id)
VALUES (nextval('seq_lifecycle_id'), 'render.lc', null);
-- #3 lifecycle acl.lc (to test with ChangeAclState)
insert into lifecycles(id, name, default_state_id)
VALUES (nextval('seq_lifecycle_id'), 'acl.lc', null);
-- #4 lifecycle fail.lc (to test failed attach / changeState )
insert into lifecycles(id, name, default_state_id)
VALUES (nextval('seq_lifecycle_id'), 'fail.lc', null);
...
values (nextval('seq_lifecycle_state_id'), 'newRenderTask', '<config>' ||
                                                            ...
                                                            '<nextStates/>' ||
                                                            '</config>', 'com.dewarim.cinnamon.lifecycle.NopState', 2,
        currval('seq_lifecycle_state_id'));
update lifecycles
set default_state_id=1
where id = 1;
...
values (nextval('seq_lifecycle_state_id'), 'authoring', '<config>' ||
                                                        ...
                                                        '</config>', 'com.dewarim.cinnamon.lifecycle.ChangeAclState', 3,
        currval('seq_lifecycle_state_id'));
update lifecycles
set default_state_id=1
where id = 3;
...
insert into lifecycle_states(id, name, config, state_class, life_cycle_id, copy_state_id)
values (nextval('seq_lifecycle_state_id'), 'failed', '<config></config>', 'com.dewarim.cinnamon.lifecycle.FailState', 4,
        currval('seq_lifecycle_state_id'));

-- #1 metaset type 'comment'
insert into metaset_types(id, name, is_unique)
VALUES (nextval('seq_metaset_type_id'), 'comment', false);
-- #2 metaset type 'license' (note: in production, this may be a better stored in a relation)
insert into metaset_types(id, name, is_unique)
VALUES (nextval('seq_metaset_type_id'), 'license', true);
-- tika metaset type
insert into metaset_types(id, name, is_unique)
VALUES (nextval('seq_metaset_type_id'), 'tika', true);
...
values (nextval('seq_change_trigger_id'), 'echo-test', true, 1, 'echo', true, true, true,
        '<config><remoteServer>http://localhost:20001/</remoteServer></config>', 'test', 'MICROSERVICE', false);
insert into change_triggers(id, name, active, ranking, action, pre_trigger, post_trigger, copy_file_content, config,
                            controller, trigger_type, post_commit_trigger)
values (nextval('seq_change_trigger_id'), 'nop-test', true, 1, 'nop', true, true, true,
        '<config><remoteServer>http://localhost:20001/echo</remoteServer></config>', 'changeTrigger', 'MICROSERVICE',
        false);
-- insert into change_triggers(id, name, active, ranking, action, pre_trigger, post_trigger, copy_file_content, config,
--                             controller, trigger_type, post_commit_trigger )
