...
public enum ErrorCode {
    ...
    LIFECYCLE_NOT_FOUND("Lifecycle was not found in the database"),
    LIFECYCLE_STATE_CHANGE_FAILED("Lifecycle state change failed."),
    LIFECYCLE_STATE_NOT_FOUND("Lifecycle state was not found in database"),
    ...
    NO_LOCK_PERMISSION("missing permission to (un)lock this object"),
    ...
    OBJECT_LOCKED_BY_OTHER_USER("object is locked by another user"),
