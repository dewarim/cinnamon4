...
public enum ErrorCode {
    ...
    DB_INSERT_FAILED("db insert failed", SC_INTERNAL_SERVER_ERROR),
    DB_IS_MISSING_LANGUAGE_CODE("db does not contain ISO code for undetermined language.", SC_INTERNAL_SERVER_ERROR),
    ...
    LANGUAGE_NOT_FOUND("language was not found in the database", SC_NOT_FOUND),
    ...
    OBJECT_TYPE_NOT_FOUND("object type was not found", SC_NOT_FOUND),
